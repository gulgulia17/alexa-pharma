      ...
      <section className="relative bg-gradient-to-br from-[#1E62A2] via-[#37A7DF] to-[#91C2E5] text-white py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-lg opacity-80">
            Contact us for franchise opportunities, product inquiries, or any questions
          </p>
        </div>
      </section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select onValueChange={(value) => handleInputChange("subject", value)}>
                        ...
                        <SelectContent>
                          <SelectItem value="franchise">Franchise Inquiry</SelectItem>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <Card>
              <CardContent className="p-6">
                <h3 className="font-bold mb-2">What is the minimum investment required for a franchise?</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-bold mb-2">What territories are available for franchise?</h3>
                <p className="text-gray-600">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-bold mb-2">How long does it take to set up a franchise?</h3>
                <p className="text-gray-600">
