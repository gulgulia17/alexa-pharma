      ...
      <section className="relative bg-gradient-to-br from-[#1E62A2] via-[#37A7DF] to-[#91C2E5] text-white py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 opacity-80">
            Franchise opportunities available across India for entrepreneurs, MRs, and ASMs
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Fill out the franchise inquiry form with your details</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Finalize terms and sign the franchise agreement</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[#1E62A2] rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">
                4
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  "The franchise model is transparent and profitable. Marketing support is excellent. My territory sales
