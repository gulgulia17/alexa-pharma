        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Transparent Franchise Model</h3>
              <p className="text-gray-600">Clear partnership terms with comprehensive support for franchise partners</p>
            </div>
            <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  "The franchise model is transparent and profitable. Great products with excellent marketing support."
                </p>
      ...
      <section className="py-16 bg-gradient-to-r from-[#1E62A2] to-[#37A7DF] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Be your own boss. Earn more. Grow faster with Alexa Biopharma franchise opportunities.
          </p>
          <Button asChild size="lg" className="bg-white text-[#1E62A2] hover:bg-gray-100">
